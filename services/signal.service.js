...
const getPreKeysString = async () => {
  ...
  const preKeyBundle = await generatePreKeyBundle(preKeyId, signedKeyId);
  ...
  preKeyBundle.signedPreKey.publicKey = encode(
    preKeyBundle.signedPreKey.publicKey
  );
  preKeyBundle.signedPreKey.signature = encode(
