...
function generatePreKeyBundle(preKeyId, signedPreKeyId) {
  return Promise.all([store.getIdentityKeyPair()]).then(function (result) {
...
export const getPreKeysString = async (preKeyId, signedPreKeyId) => {
  return Promise.all([
    ...
    const preKeyBundle = {
      ...
      preKey: {
        keyId: preKeyId,
        publicKey: encode(preKey.pubKey),
      },
      signedPreKey: {
        keyId: signedPreKeyId,
        publicKey: encode(signedPreKey.pubKey),
